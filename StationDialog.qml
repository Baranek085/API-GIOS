/**
 * @file StationDialog.qml
 * @brief Okno dialogowe wyświetlające informacje o stacji.
 * @author Adam Fedorowicz
 * @date 2025-04-21
 *
 * Ten plik definiuje okno dialogowe, które wyświetla szczegóły stacji,
...
/**
 * @class Window
 * @brief Okno dialogowe dla informacji o stacji.
 *
 * To okno jest modalne i wyświetla dane o stacji, w tym wykresy danych sensorów,
 * statystyki oraz możliwość zapisu danych.
 */
Window {
    id: dialog
    ...
    /// @property string saveDate Data ostatniego zapisu danych.
     ...
     * @brief Nagłówek okna.
     *
     * Wyświetla informacje o stacji, takie jak jej identyfikator, miasto i adres.
     */
    Rectangle {
        id: header
        width: parent.width
        ...
        Text {
            ...
            text: "Stacja nr " + stationId + ", " + cityName + ", " + street + (number ? " " + number : "")
            color: "white"
            font.pixelSize: 20
            font.bold: true
            ...
            Rectangle {
                ...
                Column {
                    ...
                    ComboBox {
                        ...
                        font.pixelSize: 14
                        /**
                         * @brief Obsługuje zmianę wybranego parametru.
                         *
                         * Po zmianie parametru w selektorze, pobierane są dane dla wybranego sensora.
                         */
                    ...
                    /**
                     * @brief Przycisk do zapisywania danych.
                     */
                    Button {
                        id: saveButton
                        width: parent.width
                         ...
                         *
                         * Po kliknięciu przycisku dane stacji są zapisywane do pliku JSON.
                         */
                        onClicked: {
                    ...
                    Column {
                        ...
                        Text {
                            ...
                            wrapMode: Text.WordWrap
                            /**
                             * @brief Wyświetla aktualny odczyt sensora.
                             *
    ...
    Connections {
        ...
        function onSensorDataChanged() {
            console.log("Dane sensorów zmienione, żądanie odświeżenia wykresu i aktualizacja statystyk")
            chartCanvas.requestPaint()
